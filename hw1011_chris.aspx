<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hw1011_chris.aspx.cs" Inherits="ChrisWeb.Web.Form.hw1011_chris" %>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 85%" class="info">                                    
                             <asp:DropDownList runat="server" ID="classid" CssClass="saveform validate[required]" onfocus="defaultIndex=this.selectedIndex" onchange="this.selectedIndex=defaultIndex" OnSelectedIndexChanged="classid_SelectedIndexChanged" />                               
