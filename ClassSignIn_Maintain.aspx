<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClassSignIn_Maintain.aspx.cs" Inherits="myProj2.Web.Form.ClassSignIn_Maintain" %>
...
<head runat="server">
    ...
    <title>Class Sign-in Form _ soniali</title>  
    <style type="text/css">
        .auto-style1 {
            font-size: 1em;
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 85%" class="info">                                    
                             <asp:DropDownList runat="server" ID="classid" CssClass="saveform validate[required]" onfocus="defaultIndex=this.selectedIndex" onchange="this.selectedIndex=defaultIndex" AutoPostBack="True" OnSelectedIndexChanged="classid_SelectedIndexChanged"/>                               
